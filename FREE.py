...
'\x1b[1;91m'====================================================
'\x1b[1;92m'   Github      :     MUGHAL ZADA
'\x1b[1;93m'   FB ID       :     Hassnain Mūghal
'\x1b[1;94m'   TOOL TYPE   :     FREE COMMANDS
'\x1b[1;91m'==================================================== 
'\x1b[1;92m'_________TOOL BEST HAI SO SAHE SE USE KRY
'\x1b[1;93m'====================================================
'\x1b[1;94m'MAI NE POST KEYA THA NA 
'\x1b[1;95m'SO ENJOY FREE COMMAND
 '\x1b[1;96m'====================================================              
"""
dec="2"
server="2"
...
MUGHALuser = 'Mozilla/5.0 (Linux; Android 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.181 Mobile Safari/537.36 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]'
header= {"x-fb-connection-bandwidth": str(random.randint(20000000.0, 30000000.0)), "x-fb-sim-hni": str(random.randint(20000, 40000)), "x-fb-net-hni": str(random.randint(20000, 40000)), "x-fb-connection-quality": "EXCELLENT", "x-fb-connection-type": "cell.CTRadioAccessTechnologyHSDPA", "user-agent":MUGHALuser, "content-type": "application/x-www-form-urlencoded", "x-fb-http-engine": "Liger"}
reload(sys)
...
def main_input():
    ...
    if mx=='1':
        ...
        print ("        Member In MUGHAL Paid Commands ")
        print ("        ENJOY  KRO BHI LOGO ")
        time.sleep(3.5)
        main_system()
    elif mx=='6':
        os.system("git clone https://github.com/MugAhalZaDa/FREE.git")
...
def mineExt():
    ...
    print g+"[=] Extracting From MUGHAL : "+my_line[:15]
